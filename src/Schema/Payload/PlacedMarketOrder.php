...
class PlacedMarketOrder
{
     ...
     */
    public function setRejectReason(?string $rejectReason): PlacedMarketOrder
    {
     ...
     * @return PlacedMarketOrder
     */
    public function setMessage(?string $message): PlacedMarketOrder
    {
     ...
     * @return PlacedMarketOrder
     */
    public function setCommission(?MoneyAmount $commission): PlacedMarketOrder
    {
